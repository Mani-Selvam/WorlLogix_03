...
export default function TeamLeaderAttendance() {
  ...
  const checkInMutation = useMutation({
    ...
    onError: (error: any) => {
      toast({ title: "Error", description: error.message || "Failed to check in", variant: "destructive" });
    },
  });
  ...
  const checkOutMutation = useMutation({
    ...
    onError: (error: any) => {
      toast({ title: "Error", description: error.message || "Failed to check out", variant: "destructive" });
    },
  });
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-lg font-semibold" data-testid="text-clock-in">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-lg font-semibold" data-testid="text-clock-out">
          ...
          <div className="flex items-center justify-between pt-4 border-t">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold" data-testid="text-total-hours">
                {formatDuration(todayRecord?.workDuration || null)}
              </span>
            </div>
          ...
          <div className="flex gap-2">
            {!todayRecord?.checkIn && (
              ...
              >
                ...
                {checkInMutation.isPending ? "Checking In..." : "Clock In"}
              </Button>
            )}
            {todayRecord?.checkIn && !todayRecord?.checkOut && (
              ...
              >
                ...
                {checkOutMutation.isPending ? "Checking Out..." : "Clock Out"}
              </Button>
            )}
          </div>
        </CardContent>
              ...
              {recentAttendance.slice(0, 10).map((record) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <span className="font-medium">{formatDuration(record.workDuration)}</span>
