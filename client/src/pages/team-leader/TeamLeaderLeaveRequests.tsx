    ...
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex flex-wrap justify-between items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Request and manage your leaves</p>
        </div>
      ...
      <div className="grid gap-4">
        ...
        {!isLoading && leaves.length === 0 && (
          <Card className="p-6">
            <p className="text-center text-muted-foreground" data-testid="text-no-leaves">
            ...
            <div className="flex flex-wrap justify-between items-start gap-4">
              <div className="space-y-2 flex-1">
                <div className="flex flex-wrap items-center gap-3">
                  <h3 className="font-semibold text-lg capitalize" data-testid={`text-leave-type-${leave.id}`}>
                ...
                <p className="text-sm" data-testid={`text-reason-${leave.id}`}>
