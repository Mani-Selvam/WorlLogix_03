...
import { Building2, Mail, Phone, MapPin, Users, TrendingUp, Calendar, Edit, Loader2, CheckCircle2, Upload } from "lucide-react";
...
export default function CompanyProfile() {
  ...
  return (
    <div className="space-y-6 p-6 bg-background" data-testid="page-company-profile">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold" data-testid="text-page-title">Company Profile</h1>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card data-testid="card-basic-info">
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-lg" data-testid="text-company-name">{company.name}</h3>
                <Badge variant={company.isActive ? "default" : "destructive"} data-testid="badge-company-status">
            ...
            <div className="grid gap-3">
              <div>
                ...
                <p className="font-medium" data-testid="text-server-id">{company.serverId}</p>
              </div>
              <div>
        ...
        <Card data-testid="card-contact-info">
          ...
          <CardContent className="space-y-3">
            ...
            <div>
              ...
              <p className="font-medium" data-testid="text-website">{company.website || "Not specified"}</p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card data-testid="card-business-info">
          ...
          <CardContent className="space-y-3">
            ...
            <div>
              <p className="text-sm text-muted-foreground">Average Annual Turnover</p>
      ...
      <Card data-testid="card-audit-info">
        <CardHeader>
          ...
          <CardDescription>Track changes to your company profile</CardDescription>
        </CardHeader>
      ...
      <Dialog open={editDialogOpen} onOpenChange={setEditDialogOpen}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto" data-testid="dialog-edit-profile">
          <DialogHeader>
            <DialogTitle>Edit Company Profile</DialogTitle>
            <DialogDescription>
              Update your company information. All changes will be tracked with your username and timestamp.
            </DialogDescription>
          </DialogHeader>
              ...
              <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-4 mt-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground mt-1">
                        Max size: 5MB. Recommended: 500x500px
                      </p>
                    </div>
                  </div>
                </div>
                        ...
                        <Select onValueChange={field.onChange} value={field.value}>
                          ...
                          <SelectContent>
                            {designations.map((des) => (
                              <SelectItem key={des} value={des} data-testid={`option-designation-${des}`}>
                                {des}
                              </SelectItem>
                            ))}
                          </SelectContent>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input {...field} placeholder="Optional" data-testid="input-phone" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea {...field} placeholder="23, Main Street, Perundurai" rows={2} data-testid="input-address" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input {...field} placeholder="Erode" data-testid="input-city" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input {...field} placeholder="638001" data-testid="input-pincode" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input {...field} placeholder="Tamil Nadu" data-testid="input-state" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input {...field} type="number" placeholder="25" data-testid="input-employees" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Average Annual Turnover *</FormLabel>
                        <Select onValueChange={field.onChange} value={field.value}>
                          <FormControl>
                          ...
                          <SelectContent>
                            {turnoverRanges.map((range) => (
                              <SelectItem key={range} value={range} data-testid={`option-turnover-${range}`}>
                                {range}
                              </SelectItem>
                            ))}
                          </SelectContent>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input {...field} type="number" placeholder="2005" data-testid="input-year-established" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea {...field} placeholder="Brief description about your company" rows={3} data-testid="input-description" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
