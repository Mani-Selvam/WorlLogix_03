              ...
              <CardContent className="space-y-4">
                {report.plannedTasks && (
                  <div>
                    ...
                    <p className="text-sm whitespace-pre-wrap" data-testid={`text-planned-${report.id}`}>
                      {report.plannedTasks}
                    </p>
                  </div>
                )}
                {report.completedTasks && (
                  <div>
                    ...
                    <p className="text-sm whitespace-pre-wrap" data-testid={`text-completed-${report.id}`}>
                      {report.completedTasks}
                    </p>
                  </div>
                )}
                {report.pendingTasks && (
                  <div>
                    ...
                    <p className="text-sm whitespace-pre-wrap" data-testid={`text-pending-${report.id}`}>
                      {report.pendingTasks}
                    </p>
                  </div>
                )}
                {report.notes && (
                  <div>
                    ...
                    <p className="text-sm whitespace-pre-wrap" data-testid={`text-notes-${report.id}`}>
                      {report.notes}
                    </p>
                  </div>
                )}
