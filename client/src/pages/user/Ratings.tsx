...
export default function Ratings() {
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <div>
        <h2 className="text-2xl sm:text-3xl font-bold">Performance Ratings</h2>
        <p className="text-sm sm:text-base text-muted-foreground mt-1">Your performance feedback</p>
      </div>
